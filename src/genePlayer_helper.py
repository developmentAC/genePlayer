...
def helper_extended():
	...
	print(printWithColour(BIYellow,"\t sudo apt install python3-pip"))

	print(printWithColour(BICyan,"\n\t # Install a virtualizing library"))
	print(printWithColour(BIYellow,"\t # pip install virtualenv"))

	print(printWithColour(BICyan,"\n\t # If the above does not work, try:"))
	print(printWithColour(BIYellow,"\t sudo apt install python3-virtualenv"))

	print(printWithColour(BICyan,"\n\t # Then Run the virtual environment"))
	print(printWithColour(BIYellow,"\t virtualenv myenv -p python3"))

	print(printWithColour(BICyan,"\n\t # Begin virtual session"))
	print(printWithColour(BIYellow,"\t source myenv/bin/activate"))

	print(printWithColour(BICyan,"\n\t # More libraries to install"))
	print(printWithColour(BIYellow,"\t pip install biopython"))
